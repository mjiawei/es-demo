...
public class EsDemoApplicationTests {
	...
	private Logger logger = LoggerFactory.getLogger(EsDemoApplicationTests.class);

	public final static String HOST = "172.29.80.171";
	...
	public void getData1() {
		GetResponse getResponse = client.prepareGet("weixin", "tweet", "1").get();
	...
	public void testSearch()
	{
		SearchResponse searchResponse = client.prepareSearch("msg","momo")
				...
				.setQuery(QueryBuilders.matchQuery("username", "王").operator(Operator.OR)) //根据tom分词查询name,默认or
				//.setQuery(QueryBuilders.multiMatchQuery("王", "username", "msg")) //指定查询的字段
